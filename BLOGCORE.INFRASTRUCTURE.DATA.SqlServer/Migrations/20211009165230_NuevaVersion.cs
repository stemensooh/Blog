...
{
    public partial class NuevaVersion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalVistas = table.Column<long>(nullable: false),
                    TotalVistasAnonimas = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Mensaje = table.Column<string>(maxLength: 1000, nullable: true),
                    ComentarioId = table.Column<long>(nullable: false),
                    TotalReaccion = table.Column<long>(nullable: false),
                    UsuarioId = table.Column<long>(nullable: false),
                    PostId = table.Column<long>(nullable: false),
                    FechaCreacion = table.Column<DateTime>(nullable: false),
                    Estado = table.Column<bool>(nullable: false)
